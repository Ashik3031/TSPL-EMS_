...
<div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-2 lg:p-1">
  <div className="flex items-center gap-3 lg:gap-4">
    ...
    <div className="min-w-0">
      ...
      <p className="text-sm lg:text-xl font-extrabold text-yellow-900 truncate uppercase" data-testid="top-agent-month-name">
        {topStats.topAgentMonth.name}
      </p>
      <p className="text-xs lg:text-sm text-yellow-700" data-testid="top-agent-month-activations">
        <span className="font-extrabold text-base lg:text-xl">{topStats.topAgentMonth.activations}</span> activations
      </p>
    </div>
  </div>
</div>
...
<div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-2 lg:p-1">
  <div className="flex items-center gap-3 lg:gap-4">
    ...
    <div className="min-w-0">
      ...
      <p className="text-sm lg:text-lg font-extrabold text-blue-900 truncate uppercase" data-testid="top-agent-today-name">
        {topStats.topAgentToday.name}
      </p>
      <p className="text-xs lg:text-sm text-blue-700" data-testid="top-agent-today-submissions">
        <span className="font-extrabold text-base lg:text-xl">{topStats.topAgentToday.submissions}</span> submissions
      </p>
    </div>
  </div>
</div>
